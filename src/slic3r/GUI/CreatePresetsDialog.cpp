...
#define SELECT_ALL_OPTION_COLOUR wxColour("#6E8CA0")
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(110, 140, 160), StateColor::Pressed), std::pair<wxColour, int>(wxColour(110, 140, 160), StateColor::Hovered),
