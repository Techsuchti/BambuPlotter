...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    wxColour selected_btn_bg("#6E8CA0");    // Gradient #6E8CA0
    if (m_selection >= 0) {
    ...
    StateColor bg_color = StateColor(
        std::pair{wxColour(110, 140, 160), (int) StateColor::Hovered},
        std::pair{wxColour(110,140, 160), (int) StateColor::Normal});
    m_pageButtons[m_selection]->SetBackgroundColor(bg_color);
