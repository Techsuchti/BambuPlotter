    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_ams_backup_tip->SetForegroundColour(wxColour("#6E8CA0"));
    ...
    m_link_edit_nozzle->SetForegroundColour(0x6E8CA0);
    ...
    m_statictext_finish->SetForegroundColour(wxColour(110, 140, 160));
...
void SelectMachineDialog::show_timelapse_storage_dialog(MachineObject* obj)
{
    ...
    if (show_confirm_btn) {
        ...
        StateColor confirm_bg(std::pair<wxColour, int>(wxColour(110, 140, 160), StateColor::Normal));
    ...
    if (!show_confirm_btn) {
        StateColor cancel_bg(std::pair<wxColour, int>(wxColour(110, 140, 160), StateColor::Normal));
...
void PrintOptionItem::doRender(wxDC& dc)
{
    ...
    for (auto it = m_ops.begin(); it != m_ops.end(); ++it)
    {
        ...
        {
            const wxColour& clr = m_enable ? StateColor::darkModeColorFor("#6E8CA0") : StateColor::darkModeColorFor(wxColour(144, 144, 144));
            dc.SetPen(wxPen(clr));
