...
void ExtrusionCalibration::create()
{
    ...
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(110, 140, 160), StateColor::Enabled) });
    ...
    m_cali_cancel->SetBorderColor(wxColour(110, 140, 160));
    ...
    m_button_save_result->SetBorderColor(wxColour(110, 140, 160));
